...
\includedrill{代入(A)}{code/polynomial_substitute_integer}
...
\includedrill{代入(B)}{code/polynomial_substitute_rational_number}
...
\includedrill{1次方程式}{code/equation_deg_1}
...
\includedrill{2次方程式}{code/equation_deg_2}
...
\includedrill{1次不等式}{code/inequality_deg_1}
...
\includedrill{円の方程式}{code/polynomial_circle_equation}
...
\includedrill{微分 多項式}{code/polynomial_differential}
